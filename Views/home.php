...
<head>
    <title>Status - API de Pagamento PagSeguro</title>
    ...
    <div class="card ">
        ...
        <div class="card-body">
            <div class="text-center ">
                ...
                <p class="card-text text-muted mb-3">OBS.: Sempre que alterar algum parâmetro no .env é necessário dar um restart no server PHP</p>
            </div>
        </div>
